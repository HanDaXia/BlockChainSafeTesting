...
int*	checkRandomNumbers(char *stream);

int
main(int argc, char *argv[])
{
	char *streamFile = "";
	int *status;
	status = checkRandomNumbers(streamFile);
...
int* checkRandomNumbers(char *stream)
{
	...
	/*for (i = 1; i <= NUMOFTESTS; i++) {
		printf("status %d = %d", i, stats[i]);
	}*/
//	int *result = (int *)malloc((NUMOFTESTS + 1) * sizeof(int));
//	for (i = 1; i <= NUMOFTESTS; i++) {
//		result[i] = stats[i];
//	}
	return stats;
