...
func main() {
	icon1, err := walk.NewIconFromFile("C:/Users/syl/go/src/github.com/lxn/walk/examples/img/check.ico")
	if err != nil {
		log.Fatal(err)
	}
	icon2, err := walk.NewIconFromFile("C:/Users/syl/go/src/github.com/lxn/walk/examples/img/stop.ico")
	if err != nil {
		log.Fatal(err)
	}
